...
addToCart = () => {
  ...
  let productName =  event.target.classList.contains("add_to_cart__button")? event.target.previousElementSibling.firstElementChild.innerText : event.target.parentElement.previousElementSibling.firstElementChild.innerText;

  let productPrice = event.target.classList.contains("add_to_cart__button")? event.target.previousElementSibling.firstElementChild.nextElementSibling.innerText : event.target.parentElement.previousElementSibling.firstElementChild.nextElementSibling.innerText;
